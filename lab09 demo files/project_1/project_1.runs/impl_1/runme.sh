...
HD_PWD='C:/Users/iviskena/Desktop/lab09 demo files/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab09_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab09_top.tcl -notrace

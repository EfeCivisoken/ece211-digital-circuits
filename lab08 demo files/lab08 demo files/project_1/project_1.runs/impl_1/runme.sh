...
HD_PWD='C:/Users/iviskena/Desktop/lab08 demo files/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab08_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab08_top.tcl -notrace

...
HD_PWD='C:/Users/iviskena/Downloads/lab5 demo/project_5/project_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab05_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab05_top.tcl

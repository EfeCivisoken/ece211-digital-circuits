...
HD_PWD='C:/Users/iviskena/Downloads/lab5 demo/project_5/project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab05_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab05_top.tcl -notrace
